...
const EmployeeDailyReport = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataObj.append('taskId', formData.taskId);
      formDataObj.append('workSummary', formData.workSummary);
      formDataObj.append('hoursWorked', String(formData.hoursWorked));
      formDataObj.append('blockers', formData.blockers);
      if (formData.file) {
        formDataObj.append('files', formData.file);
      }

      await employeeAPI.submitDailyReport(formDataObj);
