...
export default function MeetingRoom() {
  ...
  const handleEndCall = () => {
    ...
    let redirectPath = '/company/meetings';
    if (user?.role === 'manager') redirectPath = '/manager/meetings';
    else if (user?.role === 'employee') redirectPath = '/employee/meetings';
    else if (user?.role === 'client') redirectPath = '/client/meetings';
    else if (user?.role === 'company_admin') redirectPath = '/company/meetings';
