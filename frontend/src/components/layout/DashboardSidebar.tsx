...
const companyNavItems = [
  ...
  { label: 'Clients', icon: User, path: '/company/clients' },
...
const managerNavItems = [
  { label: 'Overview', icon: LayoutGrid, path: '/manager/dashboard' },
  ...
  { label: 'Clients', icon: User, path: '/manager/clients' },
  { label: 'Daily Reports', icon: FileText, path: '/manager/reports' },
  { label: 'Performance', icon: TrendingUp, path: '/manager/performance' },
  { label: 'Meetings', icon: CalendarClock, path: '/manager/meetings' },
  { label: 'Files', icon: Folder, path: '/manager/files' },
  { label: 'Demands', icon: CheckSquare, path: '/manager/demands' },
...
const clientNavItems = [
  ...
  { label: 'My Project', icon: FolderKanban, path: '/client/project' },
  { label: 'Meetings', icon: CalendarClock, path: '/client/meetings' },
  { label: 'Reports', icon: FileText, path: '/client/reports' },
  { label: 'Demands', icon: CheckSquare, path: '/client/demands' },
  { label: 'Notifications', icon: Bell, path: '/client/notifications' },
  { label: 'Settings', icon: Settings, path: '/client/settings' },
];

const superAdminNavItems = [
  { label: 'Overview', icon: LayoutDashboard, path: '/superadmin/dashboard' },
  { label: 'Companies', icon: FolderOpen, path: '/superadmin/companies' },
  { label: 'Subscriptions', icon: FolderKanban, path: '/superadmin/subscriptions' },
  { label: 'Platform Analytics', icon: BarChart3, path: '/superadmin/analytics' },
