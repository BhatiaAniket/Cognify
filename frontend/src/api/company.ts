...
export const companyAPI = {
  ...
  assignClient: (projectId: string, clientId: string) => api.patch(`/projects/${projectId}/assign-client`, { clientId }),
  ...
  getMeetingRequests: () => api.get('/meetings/requests'),
  handleMeetingRequest: (requestId: string, action: 'accept' | 'decline') => api.put(`/meetings/requests/${requestId}`, { action }),

  // Chat
  getChatContacts: () => api.get('/chat/contacts'),
