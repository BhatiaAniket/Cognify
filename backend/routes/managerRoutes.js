...
router.get('/demands', managerController.getClientDemands);
router.patch('/demands/:id/status', managerController.updateDemandStatus);

// ── Report Sharing ────────────────────────────────────────────────────────────
router.patch('/reports/:id/share', managerController.toggleReportSharing);
router.patch('/meetings/:id/share', managerController.toggleMeetingSharing);
router.post('/meetings/:id/share-summary', managerController.shareMeetingSummary);
