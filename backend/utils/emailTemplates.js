...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Reset Your CognifyPM Password</title>
</head>
<body style="margin: 0; padding: 0; background-color: #EAEAE4; font-family: 'Inter', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
  <table role="presentation" cellpadding="0" cellspacing="0" style="width: 100%; background-color: #EAEAE4;">
    <tr>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width: 520px; width: 100%; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding: 48px 40px 32px;">
              ...
              <p style="margin: 0 0 28px; color: #555555; font-size: 15px; line-height: 1.6;">
                Hi <strong>${userName}</strong>,<br><br>
                We received a request to reset your CognifyPM account password. Click the button below to set a new password.
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                  <td align="center">
                    <a href="${resetUrl}" target="_blank" style="display: inline-block; padding: 14px 36px; background-color: #0D0D0D; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 999px; letter-spacing: 0.02em;">
                      Reset My Password →
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin: 28px 0 0; color: #888888; font-size: 13px; line-height: 1.5;">
                Or copy and paste this link into your browser:<br>
                <a href="${resetUrl}" style="color: #0D0D0D; word-break: break-all;">${resetUrl}</a>
              </p>
            </td>
          </tr>
...
module.exports = { getVerificationEmailTemplate, getPasswordResetEmailTemplate };
